...
class Builder
{
   protected QueryBuilder $queryBuilder;
    ...
    public function orWhere(): Builder
    {
        ...
        public function whereLike(): Builder
    {
        call_user_func_array([$this->queryBuilder, 'whereLike'], func_get_args());

        return $this;
    }

    public function orWhereLike(): Builder
    {
        call_user_func_array([$this->queryBuilder, 'orWhereLike'], func_get_args());
